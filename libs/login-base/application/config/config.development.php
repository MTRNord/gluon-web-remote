...
return array(
	 ...
	 */
	#'PATH_CONTROLLER' => realpath(dirname(__FILE__).'/libs/login-base/').'/application/controller/',
	'PATH_CONTROLLER' => 'libs/login-base/application/controller/',
	'PATH_VIEW' => 'libs/login-base/application/view/',
	/**
	 ...
	 */
	'PATH_AVATARS' => '/libs/login-base/public/avatars/',
